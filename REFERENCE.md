...
the resource name.
* [`libvirt::nwfilter`](#libvirtnwfilter): 

**Resource types**

* [`libvirt_pool`](#libvirt_pool): Manages libvirt pools  Example :   libvirt_pool { 'default' :     ensure => absent   }    libvirt_pool { 'mydirpool' :     ensure    => prese
...
* [`libvirt::get_merged_profile`](#libvirtget_merged_profile): function to merge profiles.  A profile is a hash of values. A profile can depend on another profile. The base for a profile can be configured
* [`libvirt_generate_mac`](#libvirt_generate_mac): 
...
* [`libvirt_generate_uuid`](#libvirt_generate_uuid): 
...
Default value: $libvirt::drop_default_net
...
The libvirt_generate_mac function.
...
The libvirt_generate_uuid function.
